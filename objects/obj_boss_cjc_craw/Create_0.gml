...
blockReady = function(block) {
	if block==obj_boss_cjc_block_bomb01 {
		scr_sprite_change(spr_boss_cjc_crawcen_catch_get2_back, 0, 0)
		catch_block_xof=80
		catch_block_yof=0
		catch_block=instance_create_depth(
			x+catch_block_xof*image_xscale, y+catch_block_yof*image_yscale, depth-10, obj_boss_cjc_block_bomb01)
	} else if block==obj_boss_cjc_block_bomb02 {
		scr_sprite_change(spr_boss_cjc_crawcen_catch_get_back, 0, 0)
		catch_block_xof=56
		catch_block_yof=0
		catch_block=instance_create_depth(
			x+catch_block_xof*image_xscale, y+catch_block_yof*image_yscale, depth-10, obj_boss_cjc_block_bomb02)
	}
	with catch_block {
		use_move_sys=false
	}
