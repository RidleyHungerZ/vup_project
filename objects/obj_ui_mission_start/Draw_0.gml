...
//mission
draw_sprite_ext(spr_ui_grd_title_mission_start_ch, 0, vcx-384, vcy+104, 1, 1, 0, c_white, mission_alpha)
draw_sprite_ext(spr_ui_grd_title_mission_start, 0, vcx, vcy, 1, 1, 0, c_white, mission_alpha)
//边框
